...
E2E на Playwright: 46 сценариев в двух окружениях — десктопный Chromium
и мобильный WebKit (iPhone 13).
...
CI прогоняет их при каждом пуше и pull request — `.github/workflows/e2e.yml`.
